...
# Fees and settings
coinex_fee = 0.001
ir_fee = 0.005  # IR has slightly higher fee (0.5%)
network_fee = 0.0001
tax_rate = 0.0
...
def check_arbitrage_opportunity():
    ...
    print(f"IR     - Bid: {ir_bid}, Ask: {ir_ask}")

    if coinex_ask and ir_bid and coinex_ask < ir_bid:
        simulate_arbitrage(
    ...
    if ir_ask and coinex_bid and ir_ask < coinex_bid:
        simulate_arbitrage(
            buy_price=ir_ask,
