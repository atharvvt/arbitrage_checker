...
def get_crypto_com_price(symbol="BTC/USDT"):
    try:
...
def check_arbitrage_opportunity():
    ...
    crypto_com_bid, crypto_com_ask = get_crypto_com_price()
    ...
    if bybit_ask and crypto_com_bid and bybit_ask < crypto_com_bid:
        simulate_arbitrage(
            buy_price=bybit_ask,
    ...
    if crypto_com_ask and bybit_bid and crypto_com_ask < bybit_bid:
        simulate_arbitrage(
